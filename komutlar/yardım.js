  ...
  if(kategoriler.some(a => cat.toLowerCase() === a.toLowerCase())) {
    ...
    message.channel.send(new Discord.RichEmbed()
                         ...
                         .addField(dil.yazılar.yardım.yetkii, command.conf.permLevel.toString()
                                   ...
                                   .replace("1", dil.yazılar.yardım.yetki.at)
                                   .replace("2", dil.yazılar.yardım.yetki.yasakla)
                                   .replace("3", dil.yazılar.yardım.yetki.syönet)
                                   .replace("4", dil.yazılar.yardım.yetki.yönetci)
                                   .replace("5", dil.yazılar.yardım.yetki.sahip)
                                  )

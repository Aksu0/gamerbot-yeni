...
exports.run = async (client, message, args, dil, renk, dbl) => {
 ...
 message.channel.send(new Discord.RichEmbed()
            ...
            .addField(dil.yazılar.uptime, moment.duration(new Date().getTime() - client.readyTimestamp).format(`D [${dil.yazılar.gün}], H [${dil.yazılar.saat}], m [${dil.yazılar.dakika}], s [${dil.yazılar.saniye}]`), true)
